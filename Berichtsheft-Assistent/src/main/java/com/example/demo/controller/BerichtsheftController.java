...
public class BerichtsheftController {
	...
	private final BerichtsheftService berichtsheftServie;
	
	@Operation(summary = "Create Berichtsheft", description = "Creating a berichtsheft by benutzer id and object.")
	@PostMapping("/benutzer/{benutzerId}/berichtsheft")
	public ResponseEntity<BerichtsheftResponse> create(@PathVariable Long benutzerId, @Valid @RequestBody BerichtsheftRequest request){
		BerichtsheftResponse response = berichtsheftServie.createBerichtsheft( benutzerId, request);
	...
	public ResponseEntity<List<BerichtsheftResponse>> read(@PathVariable Long benutzerId){
		List<BerichtsheftResponse> berichtsheft = berichtsheftServie.getBerichtshefte(benutzerId);
	...
	public ResponseEntity<BerichtsheftResponse> update(@PathVariable Long berichtsheftId, @Valid @RequestBody BerichtsheftRequest request){
		BerichtsheftResponse result = berichtsheftServie.updateBerichtsheft(berichtsheftId, request);
	...
	public ResponseEntity<Void> delete(@PathVariable Long berichtsheftId){
		berichtsheftServie.deleteBerichtsheft(berichtsheftId);
